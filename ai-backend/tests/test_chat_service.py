...
from src.services.chat_service import fetch_party_response_stream, process_party
...
def test_is_video_link() -> None:
    ...
    from src.services.chat_service import _is_video_link
...
def test_source_snippet_normalizes_and_truncates() -> None:
    ...
    from src.services.chat_service import _SNIPPET_MAX_CHARS, _source_snippet
